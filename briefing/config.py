...
DEFAULTS = {
    ...
    "windows": {
        ...
        "ai_papers": {"min_age_days": 10, "max_age_days": 60},
        "news": {"min_age_days": 10, "max_age_days": 45},
        "blogs": {"min_age_days": 7, "max_age_days": 60},
        "hacker_news": {"min_age_days": 5, "max_age_days": 45},
    },
    "signals": {"hn_min_points_ai": 300, "hn_min_points_science": 150, "hf_min_upvotes": 40,
                "papers_per_stream": 25, "max_news_headlines": 2500},
